...
* The table 1 above showed the data chracterization of age, weight, dose, and peak concentration by using the joint data, but since the age, weight and dose were repeated 11 times, the standard deviations were underestimated. To make the result more precise, table 2 showed the result by using data without repeatation. 
